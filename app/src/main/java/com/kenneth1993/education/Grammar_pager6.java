...
public class Grammar_pager6 extends PagerAdapter {

    LayoutInflater inflater1;

    public Grammar_pager6(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if(position==0){img.setText(R.string.btn6_1);}
        if(position==1){img.setText(R.string.btn6_2);}
