...
public class Grammar_07 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager7 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_07);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager7);
        adapter=new Grammar_pager7(getLayoutInflater());
