...
public class Grammar_14 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager14 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_14);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager14);
        adapter=new Grammar_pager14(getLayoutInflater());
