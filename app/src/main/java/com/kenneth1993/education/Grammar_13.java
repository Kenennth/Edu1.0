...
public class Grammar_13 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager13 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_13);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager13);
        adapter=new Grammar_pager13(getLayoutInflater());
