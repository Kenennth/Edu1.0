...
public class Grammar_04 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager4 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_04);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager4);
        adapter=new Grammar_pager4(getLayoutInflater());
