...
public class Grammar_pager3 extends PagerAdapter {

    LayoutInflater inflater3;

    public Grammar_pager3(LayoutInflater inflater) {
        this.inflater3 = inflater;
    }

    @Override
    public Object instantiateItem(ViewGroup container, int position) {

        View page1=inflater3.inflate(R.layout.page,container,false); // page의 infalter
        ...
        if(position==0){img.setText(R.string.btn3_1);}
        if(position==1){img.setText(R.string.btn3_2);}
