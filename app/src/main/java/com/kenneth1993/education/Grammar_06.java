...
public class Grammar_06 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager6 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_06);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager6);
        adapter=new Grammar_pager6(getLayoutInflater());
