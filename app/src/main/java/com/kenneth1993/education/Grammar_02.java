...
public class Grammar_02 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager2 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_02);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager2);
        adapter=new Grammar_pager2(getLayoutInflater());
