...
public class Grammar_08 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager8 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_08);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager8);
        adapter=new Grammar_pager8(getLayoutInflater());
