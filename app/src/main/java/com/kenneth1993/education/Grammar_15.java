...
public class Grammar_15 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager15 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_15);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager15);
        adapter=new Grammar_pager15(getLayoutInflater());
