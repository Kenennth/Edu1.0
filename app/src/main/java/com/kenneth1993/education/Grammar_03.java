...
public class Grammar_03 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager3 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_03);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager3);
        adapter=new Grammar_pager3(getLayoutInflater());
