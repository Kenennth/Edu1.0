...
public class Grammar_pager8 extends PagerAdapter {

    LayoutInflater inflater1;

    public Grammar_pager8(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if(position==0){img.setText(R.string.btn8_1);}
        if(position==1){img.setText(R.string.btn8_2);}
        if(position==2){img.setText(R.string.btn8_3);}
