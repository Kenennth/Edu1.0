...
public class Grammar_09 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager9 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_09);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager9);
        adapter=new Grammar_pager9(getLayoutInflater());
