...
public class Grammar_pager extends PagerAdapter {

    LayoutInflater inflater1;

    public Grammar_pager(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if(position==0){img.setText(R.string.btn1);}
        if(position==1){img.setText(R.string.btn1_1);}
        if(position==2){img.setText(R.string.btn1_2);}
        if(position==3){img.setText(R.string.btn1_3);}
        if(position==4){img.setText(R.string.btn1_4);}
