...
public class Grammar_10 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager10 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_10);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager10);
        adapter=new Grammar_pager10(getLayoutInflater());
