...
public class Grammar_12 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager12 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_12);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager12);
        adapter=new Grammar_pager12(getLayoutInflater());
