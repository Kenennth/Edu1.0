...
public class Grammar_pager11 extends PagerAdapter {

    LayoutInflater inflater1;

    public Grammar_pager11(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if(position==0){img.setText(R.string.btn11_1);}
        if(position==1){img.setText(R.string.btn11_2);}
        if(position==2){img.setText(R.string.btn11_3);}
        if(position==3){img.setText(R.string.btn11_4);}
