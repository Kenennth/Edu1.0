...
public class Grammar_pager5 extends PagerAdapter {

    LayoutInflater inflater1;

    public Grammar_pager5(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if(position==0){img.setText(R.string.btn5_1);}
        if(position==1){img.setText(R.string.btn5_2);}
