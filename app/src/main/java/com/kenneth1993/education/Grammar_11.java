...
public class Grammar_11 extends AppCompatActivity {

    ViewPager pager;
    Grammar_pager11 adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_11);

        actlist.add(this);

        pager=(ViewPager)findViewById(R.id.pager11);
        adapter=new Grammar_pager11(getLayoutInflater());
